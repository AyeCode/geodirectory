...
function setGeodirMapSize(resize){var isAndroid=navigator.userAgent.toLowerCase().indexOf("android")>-1?true:false;var dW=parseInt(jQuery(window).width());var dH=parseInt(jQuery(window).height());if(GeodirIsiPhone()||isAndroid&&(dW>dH&&dW==640&&dH==360||dH>dW&&dW==360&&dH==640||(dW>dH&&dW==533&&dH==320||dH>dW&&dW==320&&dH==533)||(dW>dH&&dW==960&&dH==540||dH>dW&&dW==540&&dH==960)))jQuery(document).find(".geodir_map_container").each(function(){jQuery(this).addClass("geodir-map-iphone")});else{jQuery(document).find(".geodir_map_container").each(function(){var $this=this;var gmcW=parseInt(jQuery($this).width());var gmcH=parseInt(jQuery($this).height());if(gmcW>=400&&gmcH>=350)jQuery($this).removeClass("geodir-map-small").addClass("geodir-map-full");else jQuery($this).removeClass("geodir-map-full").addClass("geodir-map-small")});if(resize)jQuery(document).find(".geodir_map_container_fullscreen").each(function(){var $this=this;var gmcW=parseInt(jQuery(this).find(".gm-style").width());var gmcH=parseInt(jQuery(this).find(".gm-style").height());if(gmcW>=400&&gmcH>=
