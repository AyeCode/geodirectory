...
//					print_r( $args );echo '###'.$type;
//					$args['show'] = 'icon-label-value';
//					$output = geodirectory()->fields->render_field_output( $field, $post, $location, $args );
					$output = \geodir_render_field_output( $field, $args['id'], $args );
//					$output = apply_filters( "geodir_custom_field_output_{$type}", '', $args['location'], $field, $args['id'], $args['show'], $the_post );
//					return print_r($args,true).$output;
