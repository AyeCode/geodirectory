...
/**
 * Formatter utility class for data sanitization and formatting.
 */
final class Formatter {
	...
	public static function clean( $var ) {
		if ( is_array( $var ) ) {
			...
			return is_scalar( $var ) ? self::sanitize_text_field( $var ) : $var;
		}
	}
	 ...
	 */
	public static function clean_slug( string $string ): string {
	 ...
	 */
	public static function sanitize_tooltip( string $var ): string {
	 ...
	 */
	public static function get_formatted_date( string $date ) {
	 ...
	 */
	public static function get_formatted_time( string $time ) {
	 ...
	 */
	public static function date_time_format( $sep = null ): string {
		if ( $sep === null || $sep === false ) {
			$sep = ' ';
		}

		$date_time_format = self::date_format() . $sep . self::time_format();
	 ...
	 */
	public static function format_decimal( $number, $dp = false, bool $trim_zeros = false ): string {
		$locale   = localeconv();
	 ...
	 */
	public static function timezone_utc_offset( string $timezone_string = '', bool $dst = true ): string {
		$offset = '';
	 ...
	 */
	public static function timezone_offset(): float {
	 ...
	 */
	public static function sanitize_html_field( string $str, ?array $allowed_html = null ): string {
		if ( $str === '' ) {
			return $str;
		}
	 ...
	 */
	public static function sanitize_keyword( string $keyword, string $extra = '' ): string {
		$raw_keyword = $keyword;
		...
		$replacements = self::keyword_replacements();
	 ...
	 */
	public static function keyword_replacements(): array {
		$replacements = array(
			'‘'       => '',
			'’'       => '',
			"'"       => '',
	 ...
	 */
	public static function blocks_to_shortcodes( string $content ): string {
	 ...
	 */
	public static function untexturize( string $text ): string {
		$orig_text = $text;
	 ...
	 * @return string The string replaced with HTML entities.
	 */
	public static function unwptexturize( string $text ): string {
		if ( $text == '' ) {
			return $text;
		}
	 ...
	 */
	public static function sanitize_float( $number ): float {
		$locale = localeconv();
	 ...
	 * @return string Sanitized string.
	 */
	public static function sanitize_html_class( $string ): string {
		if ( empty( $string ) ) {
			return $string;
		}
	 ...
	 */
	public static function minify_js( string $script ): string {
		if ( trim( $script ) === "" ) {
			return $script;
		}
