var GeoDir_Admin_API_Keys = {
    ...
    saveKey: function(e) {
		...
		var data = {
			action: 'geodir_api_keys_ajax',
			nonce: geodir_admin_api_keys_params._nonce,
        ...
        jQuery.ajax({
            ...
            success: function(res, textStatus, xhr) {
                ...
                if (res.success) {
                    ...
                    jQuery('h3', $self.el).first().append('<div class="gd-api-message updated"><p>' + data.message + '</p></div>');
                    ...
                    jQuery('h3', $self.el).first().append('<div class="gd-api-message error"><p>' + res.data.message + '</p></div>');
                }
