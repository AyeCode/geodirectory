...
function gd_wizard_add_widgets($security){
    ...
    jQuery.ajax({
        ...
        beforeSend: function()
        {
            jQuery( ".geodir-wizard-widgets-result" ).html('<i class="fa fa-refresh fa-spin" style="font-size:24px"></i>');
...
function gd_wizard_setup_menu($security){
    ...
    jQuery.ajax({
        ...
        beforeSend: function()
        {
            jQuery( ".geodir-wizard-menu-result" ).html('<i class="fa fa-refresh fa-spin" style="font-size:24px"></i>');
