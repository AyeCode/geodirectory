...
<div id="geodir_wrapper">
    ...
    <div class="clearfix geodir-common">
        ...
        <div class="geodir-onethird" <?php if($width = get_option('geodir_width_author_left_section') ) { echo 'style="width:'.$width.'%;"'; } ?> >
        ...
        <div class="geodir-onethird" <?php if($width = get_option('geodir_width_author_contant_section') ) { echo'style="width:'.$width.'%;"';} ?> >
        ...
        <div class="geodir-onethird" <?php if($width = get_option('geodir_width_author_right_section') ) { echo 'style="width:'.$width.'%;"';} ?> >
