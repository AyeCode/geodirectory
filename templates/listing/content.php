...
global $post, $gridview_columns, $grid_view_class, $gd_session, $related_nearest, $related_parent_lat, $related_parent_lon;
...
<li <?php geodir_listing_class( $post ); ?> <?php geodir_listing_attrs( $post ); ?>>
    <article <?php geodir_listing_inner_class( $post ); ?>>
