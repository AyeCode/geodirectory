...
global $geodirectory;
?>
<form class="<?php echo esc_attr( $form_class ); ?>" data-show="<?php echo esc_attr( $show ); ?>" name="geodir-listing-search" action="<?php echo esc_url( geodir_search_page_base_url() ); ?>" method="get">
