	...
	<div class="map-category-listing<?php echo $cat_filter_class; ?>">
		...
		<div id="<?php echo $map_canvas; ?>_cat"
			...
			<?php if ( ! empty( $map_options['cat_filter'] ) ) { ?>
				...
				<div class="geodir_toggle"><div class="py-2 px-1"><i class="fas fa-circle-notch fa-spin mr-1" aria-hidden="true"></i> <small><?php _e( "Loading categories...", "geodirectory" ); ?></small></div></div>
			<?php } else { ?>
