...
Top Business Directory plugin for WordPress. Build a City Business Directory, Classified Ads, Real Estate Directory, Job Board, Member Directory
...
== ⚡ ASK AND YOU SHALL RECEIVE â€“ DELIVER SPEEDY RESULTS ==
...
* **Restaurants** Create an online food directory highlighting the best restaurants around town, along with detailed menus and visitor reviews.
...
= 2.2.15 =
[GeoDirectory changelog for version 2.2.15](https://wpgeodirectory.com/change-logs-v2/#v2.2.15).

= 2.2.14 =
[GeoDirectory changelog for version 2.2.14](https://wpgeodirectory.com/change-logs-v2/#v2.2.14).

= 2.2.13 =
[GeoDirectory changelog for version 2.2.13](https://wpgeodirectory.com/change-logs-v2/#v2.2.13).

= 2.2.12 =
[GeoDirectory changelog for version 2.2.12](https://wpgeodirectory.com/change-logs-v2/#v2.2.12).
