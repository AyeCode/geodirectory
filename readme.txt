...
= GeoDirectory v2.8.185 - 2026-09-TBD =
* GD widgets missing from Elementor v4.3 widget panel & Element Manager - COMPATIBILITY

= GeoDirectory v2.8.184 - 2026-09-24 =
* Added extra sanitization for business hours inputs to prevent XSS vulnerability - FIXED/SECURITY

= GeoDirectory v2.8.183 - 2026-09-23 =
...
= GeoDirectory v2.8.179 - 2026-09-02 =
* Vulnerability Disclosure Policy (VDP) changes in the readme file - CHANGED

= GeoDirectory v2.8.178 - 2026-08-24 =
* Map style conflict with Astra theme - FIXED
* Extra sanitization added for Popover HTML content – FIXED/SECURITY
...
= GeoDirectory v2.8.173 - 2026-08-18 =
...
* Added include, parent, term_order sorting options in GD > Categories – ADDED

= GeoDirectory v2.8.171 - 2026-08-10 =
* Delete post revision is not working after update - FIXED

= GeoDirectory v2.8.170 - 2026-08-07 =
* Added extra sanitization in AJAX post save - SECURITY
* Added extra validation in map markers REST API route - FIXED

= GeoDirectory v2.8.169 - 2026-07-29 =
