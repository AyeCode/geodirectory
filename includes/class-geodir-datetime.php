...
/**
 * GeoDir Wrapper for PHP DateTime which adds support for gmt/utc offset when a timezone is absent.
 *
 * @class    GeoDir_DateTime
 * @since    2.0.0
 * @package  GeoDirectory/Classes
 * @category Class
 * @author   GeoDirectory
 */
class GeoDir_DateTime extends DateTime {
