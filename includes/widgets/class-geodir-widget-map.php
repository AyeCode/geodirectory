	...
	public static function display_map( $params ) { //geodir_error_log( $params, 'display_map', __FILE__, __LINE__ );
		...
		<div class="geodir-map-wrap geodir-<?php echo $map_type; ?>-map-wrap">
			...
			<div class="stick_trigger_container">
				...
				<div class="top_banner_section geodir_map_container <?php echo $map_canvas; ?>" id="sticky_map_<?php echo $map_canvas;?>" style="width:<?php echo $width; ?>;min-height:<?php echo $height; ?>;">
					<!--END map_background-->
					<div class="map_background">
						<div class="top_banner_section_in clearfix">
							<div class="<?php echo $map_canvas; ?>_TopLeft TopLeft"><span class="triggermap" id="<?php echo $map_canvas; ?>_triggermap"><i class="fa fa-arrows-alt"></i></span></div>
							...
							<div id="<?php echo $map_canvas; ?>_wrapper" class="main_map_wrapper" style="height:<?php echo $height; ?>;width:<?php echo $width; ?>;">
								<div class="iprelative">
									<div id="<?php echo $map_canvas; ?>" class="geodir-map-canvas" data-map-type="<?php echo $map_type; ?>" data-map-canvas="<?php echo $map_canvas; ?>" style="height:<?php echo $height; ?>;width:<?php echo $width; ?>;"></div>
									<div id="<?php echo $map_canvas; ?>_loading_div" class="loading_div" style="height:<?php echo $height; ?>;width:<?php echo $width; ?>;"></div>
									<div id="<?php echo $map_canvas; ?>_map_nofound" class="advmap_nofound"><?php echo _e( '<h3>No Records Found</h3><p>Sorry, no records were found. Please adjust your search criteria and try again.</p>', 'geodirectory' ); ?></div>
									<div id="<?php echo $map_canvas; ?>_map_notloaded" class="advmap_notloaded"><?php _e( '<h3>Google Map Not Loaded</h3><p>Sorry, unable to load Google Maps API.', 'geodirectory' ); ?></div>
								</div>
							</div>
		...
		if ( ! empty( $map_options['map_directions'] ) ) {
			...
			<div class="geodir-map-directions-wrap">
				<div class="gd-input-group gd-get-directions">
					<div class="gd-input-group-addon gd-directions-left">
						<div class="gd-input-group">
							<input type="text" id="<?php echo $map_canvas; ?>_fromAddress" name="from" class="gd-form-control textfield" value="" placeholder="<?php esc_attr_e( 'Enter your location', 'geodirectory' ); ?>" />
							<div id="<?php echo $map_canvas; ?>_mylocation" class="gd-input-group-addon gd-map-mylocation" onclick="gdMyGeoDirection('<?php echo $map_canvas; ?>');" title="<?php echo esc_attr__( 'My location', 'geodirectory' ); ?>"><i class="fa fa-crosshairs fa-fw"></i></div>
						</div>
					</div>
					<div class="gd-input-group-addon gd-directions-right gd-mylocation-go"><input type="button" value="<?php esc_attr_e( 'Get Directions', 'geodirectory' ); ?>" class="gd-map-get-directions <?php echo $map_canvas; ?>_getdirection" id="directions" onclick="geodirFindRoute('<?php echo $map_canvas; ?>')" /></div>
				</div>
				...
				<select id="travel-units" onchange="geodirFindRoute('<?php echo $map_canvas; ?>')">
					<option value="miles" <?php selected( 'miles' == $distance_unit, true ); ?>><?php _e('Miles', 'geodirectory'); ?></option>
					<option value="kilometers" <?php selected( 'km' == $distance_unit, true ); ?>><?php _e( 'Kilometers', 'geodirectory' ); ?></option>
				</select>
				</div>
