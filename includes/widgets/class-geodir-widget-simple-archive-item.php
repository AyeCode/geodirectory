...
//			),
			...
			'title_pt'  => geodir_get_sd_padding_input('pt', array(
				'group'     => __("Title","geodirectory"),
				'row'   => array(
			...
			'title_pb'  => geodir_get_sd_padding_input('pb', array(
				'group'     => __("Title","geodirectory"),
				'row'   => array(
					'key'   => 'title-padding',
					'close'   => true,
			...
			'desc_pt'  => geodir_get_sd_padding_input('pt', array(
				'group'     => __("Description","geodirectory"),
				'row'   => array(
					'title' => __('Padding', 'geodirectory'),
					'key'   => 'desc-padding',
			...
			'desc_pb'  => geodir_get_sd_padding_input('pb', array(
				'group'     => __("Description","geodirectory"),
				'default'  => '1',
				'row'   => array(
					'key'   => 'desc-padding',
			...
			'list_pt'  => geodir_get_sd_padding_input('pt', array(
				'group'     => __("Output Location","geodirectory"),
				'row'   => array(
					'title' => __('Padding', 'geodirectory'),
					'key'   => 'list-padding',
			...
			'list_pb'  => geodir_get_sd_padding_input('pb', array(
				'group'     => __("Output Location","geodirectory"),
				'row'   => array(
					'key'   => 'list-padding',
					'close'   => true,
	...
	public function output( $instance = array(), $widget_args = array(), $content = '' ) {
		...
		if ( $is_preview ) {
			...
			if( $post->ID == geodir_archive_item_page_id() ){
...
//					$logo = "[gd_post_images title=''  id=''  types=''  fallback_types=''  ajax_load='true'  limit='1'  limit_show=''  css_class=''  type='image'  slideshow='false'  controlnav='1'  animation='slide'  show_title='false'  show_caption='false'  image_size='thumbnail'  aspect='1x1'  cover=''  link_to='post'  link_screenshot_to=''  bg=''  mt='n5'  mr=''  mb=''  ml=''  pt=''  pr=''  pb=''  pl=''  border=''  rounded=''  rounded_size=''  shadow='' ]";
			...
			else{$author_image_class = 'center';}
