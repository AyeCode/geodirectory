<?php
/**
* GeoDirectory Listing Detail User Links Widget
*
* @since 2.0.0
*
 ...
 * @since 2.0.0
 */
class GeoDir_Widget_Detail_User_Links extends WP_Widget {
    /**
     * Register the Listing Detail User Links widget with WordPress.
     *
     * @since 2.0.0
     */
    public function __construct() {
        $widget_ops = array(
            'classname' => 'gd-widget-detail-user-links',
            'description' => __( 'Display user action links on the lisitng detail page.', 'geodirectory' ),
            'customize_selective_refresh' => true,
        );
        parent::__construct( 'detail_user_links', __( 'GD > Listing Detail User Links', 'geodirectory' ), $widget_ops );
    }
