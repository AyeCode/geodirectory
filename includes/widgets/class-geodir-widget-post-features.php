...
//				'pb' => $args['item_pb'],
	...
	public function get_parsed_values( $html, $field ) {
		...
		//      // Query the DOM to find the element with the value
		//      $valueElements = $xpath->query( '//div[contains(@class, "geodir_post_meta")]/node()[not(self::span)]' );
		//      $value         = '';
		//      foreach ( $valueElements as $valueElement ) {
		//          $value .= $dom->saveHTML( $valueElement );
		//      }
