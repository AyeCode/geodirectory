 ...
 * in the background.
 *
 * @class    GeoDir_Background_Emailer
 * @version  2.0.0
...
/**
 * GeoDir_Background_Emailer Class.
 * @todo implement this as a non default option.
 */
class GeoDir_Background_Emailer extends WP_Background_Process {
	...
	protected function task( $callback ) {
		if ( isset( $callback['filter'], $callback['args'] ) ) {
			try {
				GeoDir_Emails::send_queued_transactional_email( $callback['filter'], $callback['args'] );
			} catch ( Exception $e ) {
