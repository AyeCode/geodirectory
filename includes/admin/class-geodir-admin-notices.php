...
//		if ( ! current_theme_supports( 'woocommerce' ) && ! in_array( get_option( 'template' ), gd_get_core_supported_themes() ) ) {
...
//		echo '###'.$name;
	 ...
	 */
	public static function template_file_check_notice() { return;
		$core_templates = GD_Admin_Status::scan_template_files( WC()->plugin_path() . '/templates' );
		$outdated       = false;
