...
<div id="message" class="notice-warning notice notice-alt geodir-message geodir-v1-to-v2-notice">
	...
	<p><a class="button button-primary" href="https://wpgeodirectory.com/docs-v2/geodirectory/installation/#convert" target="_blank"><i class="fas fa-book"></i> <?php _e("Documentation","geodirectory");?></a></p>
