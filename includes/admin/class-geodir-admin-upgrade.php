			...
			foreach ( $post_types as $post_type => $data ) {
				...
				if ( ! empty( $data['link_business'] ) && ! empty( $data['linkable_to'] ) && ! empty( $post_types[ $data['linkable_to'] ] ) ) {
					...
					$link_data = array(
						...
						'admin_title' => wp_sprintf( __( 'Link Posts: %s ', 'geodirectory' ), $linked_to_name ), 
						'frontend_desc' => wp_sprintf( __( 'Select your %s to link with this %s.', 'geodirectory' ), $linked_to_name, $data['labels']['singular_name'] ), 
			...
			foreach ( $post_types as $post_type ) {
				...
				$fields = array(
					array(
						...
						'admin_title' => __( 'Has Franchise?', 'geodirectory' ), 
						'frontend_desc' => __( 'Tick "Yes" if listing has franchises.', 'geodirectory' ), 
						'frontend_title' => __( 'Has Franchise?', 'geodirectory' ), 
					...
					array(
						...
						'admin_title' => __( 'Lock franchise fields', 'geodirectory' ), 
						'frontend_desc' => __( 'Select fields to lock from franchise edit.', 'geodirectory' ), 
						'frontend_title' => __( 'Lock franchise fields', 'geodirectory' ), 
						'htmlvar_name' => 'franchise_fields', 
						'sort_order' => '0',
						'option_values' => '',
						'clabels' => __( 'Lock franchise fields', 'geodirectory' ),
						'is_active' => '1', 
						'show_in' => '',  
						'packages' => $packages, 
						'for_admin_use' => '0',
					...
					array(
						...
						'admin_title' => __( 'Main Listing', 'geodirectory' ), 
						'frontend_desc' => __( 'Enter main listing ID.', 'geodirectory' ),
						'frontend_title' => __( 'Main Listing', 'geodirectory' ), 
						'htmlvar_name' => 'franchise_of', 
						'sort_order' => '0',
						'option_values' => '',
						'clabels' => __( 'Main Listing', 'geodirectory' ),
						'is_active' => '1', 
						'show_in' => '[detail]',  
						'packages' => $packages, 
						'for_admin_use' => '1',
