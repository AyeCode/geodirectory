...
function geodir_property_sale_custom_fields($post_type='gd_place',$package_id=''){
    ...
    $fields[] = array('listing_type' => $post_type,
                      ...
                      'frontend_title'          =>  __('Salary', 'geodirectory'),
                      'frontend_desc'          =>  __('Enter the Salary in $ (no currency symbol) ie: 25000', 'geodirectory'),
                      'htmlvar_name'        =>  'salary',
                      'is_active'           =>  true,
                      'for_admin_use'       =>  false,
                      'default_value'       =>  '',
    ...
    $fields[] = array('listing_type' => $post_type,
                      ...
                      'frontend_title'          =>  __('Required Experience', 'geodirectory'),
                      'frontend_desc'          =>  __('Select the number of years required experience', 'geodirectory'),
    ...
    $fields[] = array('listing_type' => $post_type,
                      ...
                      'frontend_title'          =>  __('Required Skills', 'geodirectory'),
                      'frontend_desc'          =>  __('Enter the required skills for the job', 'geodirectory'),
    ...
    $fields[] = array('listing_type' => $post_type,
                      ...
                      'frontend_title'          =>  __('Company Details', 'geodirectory'),
                      'frontend_desc'          =>  __('Enter your company details here', 'geodirectory'),
    ...
    $fields[] = array('listing_type' => $post_type,
                      ...
                      'frontend_desc'          =>  __('Enter your company name', 'geodirectory'),
    ...
    $fields[] = array('listing_type' => $post_type,
                      ...
                      'frontend_desc'          =>  __('Enter your company Logo', 'geodirectory'),
    ...
    $fields[] = array('listing_type' => $post_type,
                      ...
                      'frontend_title'          =>  __('Company Url', 'geodirectory'),
                      'frontend_desc'          =>  __('Enter your company Url', 'geodirectory'),
...
if($dummy_post_index==1){
    ...
    geodir_update_option($post_type.'_dummy_data_type','property_sale');
}
