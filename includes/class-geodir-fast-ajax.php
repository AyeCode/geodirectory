	...
	public static function allowed_plugins( $plugins = array() ) {
		...
		foreach ( $plugins as $plugin ) {
			...
			if ( in_array( $action, array( 'geodir_ajax_search' ) )
				&& ( strpos( $plugin, 'elementor' ) !== false || strpos( $plugin, 'kadence' ) !== false || strpos( $plugin, 'bb-custom-attributes' ) !== false || strpos( $plugin, 'bb-plugin' ) !== false || strpos( $plugin, 'bb-theme-builder' ) !== false || strpos( $plugin, 'buddyboss-platform' ) !== false || strpos( $plugin, 'oxygen' ) !== false || strpos( $plugin, 'wpcodebox' ) !== false || strpos( $plugin, 'breakdance' ) !== false || strpos( $plugin, 'ghostpool' ) !== false || strpos( $plugin, 'fusion-builder' ) !== false || strpos( $plugin, 'all-in-one-wp-security-and-firewall' ) !== false || strpos( $plugin, 'userswp' ) !== false || strpos( $plugin, 'uwp-membership' ) !== false || ( in_array( 'geodir_list_manager/geodir_list_manager.php', $plugins ) && ( in_array( 'posts-to-posts/posts-to-posts.php', $plugins ) || in_array( 'wp-posts-to-posts/posts-to-posts.php', $plugins ) ) && ( strpos( $plugin, 'geodir_list_manager' ) !== false || strpos( $plugin, 'posts-to-posts' ) !== false ) ) )
