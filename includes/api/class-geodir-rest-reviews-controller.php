<?php
/**
 * REST API Post Reviews controller
 *
...
/**
 * REST API Post Reviews controller class.
 *
 * @package GeoDirectory/API
 * @extends GeoDir_REST_Reviews_Controller
 */
class GeoDir_REST_Reviews_Controller extends WP_REST_Comments_Controller {
	...
	public function update_item( $request ) {
		...
		/** This action is documented in includes/api/class-geodir-rest-reviews-controller.php */
	...
	protected function check_read_post_permission( $post, $request ) {
		$posts_controller = new GeoDir_REST_Posts_Controller( $post->post_type );
